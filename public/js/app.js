  ...
  return _c(
    ...
    [
      ...
      _c("div", { staticClass: "w-full max-w-screen-xl mx-auto px-6" }, [
        _c(
          "div",
          { staticClass: "lg:flex -mx-6" },
          [
            _c(
              "nav",
              {
                staticClass:
                  "docs-index hidden w-full lg:block lg:w-1/4 xl:w-1/5 pt-6 px-6 lg:border-r z-10 lg:max-h-(screen-22) top-22 lg:sticky",
                attrs: { id: "nav" }
              },
              [
                _c("ul", [
...
var staticRenderFns = [
  function() {
    ...
    return _c(
      ...
      {
        staticClass:
          "flex items-center bg-white h-16 z-20 top-0 sticky border-t-4 border-b"
      },
      [
        _c("div", { staticClass: "container mx-auto" }, [
          _c(
            "div",
            { staticClass: "flex items-center justify-between px-6 lg:px-16" },
            [
              _c("a", { attrs: { href: "#" } }, [_vm._v("Api Management")]),
              _vm._v(" "),
              _c("div", { staticClass: "flex" }, [
                _c(
                  "a",
                  {
                    staticClass: "mx-2 text-gray-500 hover:text-gray-700",
                    attrs: { href: "#" }
                  },
                  [_vm._v("Hello")]
                )
...
var render = function() {
  ...
  return _c(
    ...
    {
      staticClass:
        "w-full lg:w-3/4 xl:w-3/5 pt-10 px-6 lg:px-12 min-h-(screen-16) markdown",
      attrs: { id: "content" }
    },
    [
      _vm._v(
        "\n    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Necessitatibus rem quidem pariatur alias maxime harum incidunt, natus in numquam saepe nulla, iure tempora praesentium quos rerum veniam laborum sapiente sint.\n"
      )
    ]
  )
}
...
var staticRenderFns = [
  function() {
    ...
    return _c(
      ...
      {
        staticClass:
          "w-full lg:w-3/4 xl:w-4/5 pt-10 px-6 lg:px-12 min-h-(screen-16) markdown",
        attrs: { id: "content" }
      },
      [
        _c("table", { staticClass: "table-fixed" }, [
          _c("thead", [
            _c("tr", [
              _c("th", { staticClass: "w-1/2 px-4 py-2" }, [_vm._v("Name")]),
              _vm._v(" "),
              _c("th", { staticClass: "w-1/4 px-4 py-2" }, [_vm._v("Author")]),
              _vm._v(" "),
...
/* harmony default export */ __webpack_exports__["default"] = (new vue_router__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  routes: [{
    ...
    path: '/about',
    name: 'about',
    component: __webpack_require__(/*! ./pages/About */ "./resources/js/pages/About.vue")["default"]
  }, {
    path: '*',
    name: 'not-found',
...
__webpack_require__(/*! /Users/abdulhafidzanshari/Sites/gateway/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Users/abdulhafidzanshari/Sites/gateway/resources/sass/app.scss */"./resources/sass/app.scss");
